          ...
          <Row className="my-3">
            { 
              ...
              ? (this.state.showDeleteButton) 
                ? <Button id="showDeleteButton" value="false" onClick={this.handleChange}>Hide Delete Button</Button>
                : <Button id="showDeleteButton" value="true" onClick={this.handleChange}>Show Delete Button</Button>
              
              : <p>You are not logged in and cannot add any points to DB!</p>
            }
            <AddPoint
