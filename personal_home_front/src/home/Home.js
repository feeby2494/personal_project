...
export default class Home extends Component {
    constructor(){
        ...
        // ComponentWillMount: 
        fetch(`${process.env.REACT_APP_API_URI}/api/home`, { method: 'get', mode: 'no-cors', })
        .then( res => res.text())
    ...
    getVideosFromBackend(playlistId, localStateVar) {
        ...
        if (!this.state[localStateVar]) {
                fetch(`${process.env.REACT_APP_API_URI}/api/videos/${playlistId}`, {
                method: 'GET',
                headers: ytHeaders,
            })
            .then( res => res.json())
    ...
    submitWebProject(event){
        ...
        fetch(`${process.env.REACT_APP_API_URI}/api/mail_in_web`, {
            method: 'POST',
