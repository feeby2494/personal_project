...
// }
  ...
  handleLevelChange(event) {
    this.setState({
      ...
      fetch(`${process.env.REACT_APP_API_URI}/api/${this.state.language}/${this.state.level}/info`, {
        method:'GET',
  ...
  getFlashCards(event) {
    // first get info
      ...
      if(this.state.lesson == 'all'){
        fetch(`${process.env.REACT_APP_API_URI}/api/${this.state.language}/${this.state.level}/all`, {
          method:'GET',
          headers: {'x-access-token': localStorage.getItem('token')}
        })
          .then((response) => response.json())
        ...
        fetch(`${process.env.REACT_APP_API_URI}/api/${this.state.language}/${this.state.level}/${this.state.lesson}`, {
          method:'GET',
          headers: {'x-access-token': localStorage.getItem('token')}
        })
          .then((response) => response.json())
