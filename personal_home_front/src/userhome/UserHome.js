...
class UserHome extends Component {
  ...
  getRepairsInProgress(currentState) {
    // if(currentState.showAdmin){
      ...
      fetch(`${process.env.REACT_APP_API_URI}/api/mail_in_repair_in_progress`, {
            method: 'GET',
            headers: headers,
        })
        .then(res=>res.json())
  ...
  getRepairsCompleted() {
    ...
    fetch(`${process.env.REACT_APP_API_URI}/api/mail_in_repair_completed`, {
          method: 'GET',
          headers: headers,
    })
    .then(res=>res.json())
  ...
  getRepairsAll() {
    ...
    fetch(`${process.env.REACT_APP_API_URI}/api/mail_in_repair`, {
          method: 'GET',
          headers: headers,
    })
    .then(res=>res.json())
  ...
  setRepairComplete() {
    ...
    fetch(`${process.env.REACT_APP_API_URI}/api/mail_in_repair/${this.state.currentDeviceID}/complete`, {
          method: 'PATCH',
          headers: headers,
    })
    .then(res=>res.json())
